...
export const services: Record<string, ServiceData> = {
  ...
  'research-evaluation': {
    ...
    description: 'We conduct rigorous process and impact evaluations of in-person and digital skilling programs. We help educational institutes, edtech companies, and nonprofits measure the results of their interventions and synthesise findings into actionable frameworks, toolkits and knowledge products.',
