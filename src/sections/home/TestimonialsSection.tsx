      ...
      <div className="page-margin max-content relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {testimonials.map((t, i) => (
            <ScrollReveal key={i} delay={0.15 * i} className="flex flex-col">
              <span className="font-display text-6xl text-pink/20 leading-none mb-4">&ldquo;</span>
              <p className="font-display text-xl leading-relaxed text-black mb-6 flex-grow">
                {t.quote}
              </p>
