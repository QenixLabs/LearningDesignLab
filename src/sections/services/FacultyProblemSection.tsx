    ...
    <section className="bg-white py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="page-margin max-content relative z-10 text-center">
        ...
        <ScrollReveal delay={0.3}>
          <p className="font-body text-[14px] leading-[23px] text-black/70 max-w-4xl mx-auto mb-8">
        ...
        <ScrollReveal delay={0.4}>
          <p className="font-body text-[14px] leading-[23px] text-black/70 max-w-4xl mx-auto">
