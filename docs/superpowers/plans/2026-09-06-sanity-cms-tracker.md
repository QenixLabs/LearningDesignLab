...
|---|------|------|-----------|--------|
| 01 | Sanity scaffold + schemas + embedded Studio | `2026-09-06-sanity-cms-01-scaffold-studio.md` | — | ⬜ Not started |
| 02 | Data extraction + query layer + seed | `2026-09-06-sanity-cms-02-query-layer-seed.md` | 01 | ⬜ Not started |
| 03 | Collections migration (Team, Publications, Conferences, Projects) | `2026-09-06-sanity-cms-03-collections-migration.md` | 02 | ⬜ Not started |
